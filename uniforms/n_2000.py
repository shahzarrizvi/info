...
def train_flow(flow, optimizer, data, dir, num_iter = 20000):
...
train_flow(flow, optimizer, D, dir + 'flow/'.format(n))
...
train_flow(flow_0, optimizer_0, D_star, dir + 'flow/'.format(n))
